"""Example of improving recall@x metric by rag"""
...
# query = "Where is the government of Germany?"
query = "Where does the chancellor work?"
...
model_baseline = SentenceTransformer('all-MiniLM-L6-v1')
...
recall_before = recall_at_k(query_vec_baseline, doc_vecs_baseline, gt_index, k=1)
print(f"Recall@1 (BEFORE improvement): {recall_before}")
...
recall_after = recall_at_k(query_vec_improved, doc_vecs_improved, gt_index, k=1)
print(f"Recall@1 (AFTER improvement): {recall_after}")