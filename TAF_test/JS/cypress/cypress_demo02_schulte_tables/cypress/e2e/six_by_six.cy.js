...
describe("6x6 Schulte Table Page", () => {
  const SIZE_LABEL = "6x6";
  const TABLE_SIZE = 36;
  ...
  it("should navigate to 6x6 grid", () => {
    menuService.navigateToSixBySix();
  ...
  it("should have cell values in range 1 to 36", () => {
    gridPage.load();
  ...
  it("should display correct description text", () => {
    gridPage.load();
    gridPage.getDescriptionText().should("contain", "1 to 36");
  });
