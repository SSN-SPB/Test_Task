...
describe("5x5 Schulte Table Page", () => {
  const SIZE_LABEL = "5x5";
  const TABLE_SIZE = 25;
  ...
  it("should navigate to 5x5 grid", () => {
    menuService.navigateToFiveByFive();
  ...
  it("should have cell values in range 1 to 25", () => {
    gridPage.load();
  ...
  it("should display correct description text", () => {
    gridPage.load();
    gridPage.getDescriptionText().should("contain", "1 to 25");
  });
