...
describe("7x7 Schulte Table Page", () => {
  const SIZE_LABEL = "7x7";
  const TABLE_SIZE = 49;
  ...
  it("should navigate to 7x7 grid", () => {
    menuService.navigateToSevenBySeven();
  ...
  it("should have cell values in range 1 to 49", () => {
    gridPage.load();
  ...
  it("should display correct description text", () => {
    gridPage.load();
    gridPage.getDescriptionText().should("contain", "1 to 49");
  });
