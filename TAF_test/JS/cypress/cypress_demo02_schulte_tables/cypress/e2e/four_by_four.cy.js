...
describe("4x4 Schulte Table Page", () => {
  const SIZE_LABEL = "4x4";
  const TABLE_SIZE = 16;
  ...
  it("should navigate to 4x4 grid", () => {
    menuService.navigateToFourByFour();
  ...
  it("should have cell values in range 1 to 16", () => {
    gridPage.load();
  ...
  it("should display correct description text", () => {
    gridPage.load();
    gridPage.getDescriptionText().should("contain", "1 to 16");
  });
