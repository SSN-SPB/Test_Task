...
describe("3x3 Schulte Table Page", () => {
  const SIZE_LABEL = "3x3";
  const TABLE_SIZE = 9;
  ...
  it("should navigate to 3x3 grid", () => {
    menuService.navigateToThreeByThree();
  ...
  it("should have cell values in range 1 to 9", () => {
    gridPage.load();
  ...
  it("should display correct description text", () => {
    gridPage.load();
    gridPage.getDescriptionText().should("contain", "1 to 9");
  });
