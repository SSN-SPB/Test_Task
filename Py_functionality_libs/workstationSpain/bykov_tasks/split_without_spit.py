...
def split(str, sep=' ', maxsplit=None):
    ...
    for x in str:
        ...
        print('The previous_indicator is: {}'.center(28, '*').format(previous_indicator))
        ...
        print('if one: {}'.format(x == sep and not previous_indicator and maxsplit_int >= 0))
        if x == sep and not previous_indicator and maxsplit_int >= 0:
            ...
            continue
        print('if one_one: {}'.format(x == sep and previous_indicator and maxsplit_int == 0))
        ...
        if x != sep and maxsplit_int <= 0:
            ...
            previous_indicator = False
            continue
        print('if three: {}'.format(x == sep and not previous_indicator and maxsplit_int < 0))
        if x == sep and not previous_indicator and maxsplit_int < 0:
            result_list.append(interim_str)
    ...
    print('if final one: {}'.format(
        interim_str == '' and previous_indicator))
    if interim_str == '' and previous_indicator:
        result_list.append(interim_str)
    print('if final2: {}'.format(
        interim_str != ''))
    if interim_str != '':
        result_list.append(interim_str)
