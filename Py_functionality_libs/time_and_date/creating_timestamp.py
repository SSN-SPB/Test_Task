...
def main():
    ts = time.time()
    st = datetime.datetime.fromtimestamp(ts).strftime('%Y_%m_%d_%H_%M_%S_%f')[:-3]
    return st, ts


if __name__ == '__main__':
    result, unixtime = main()
print(r'It displays time stam %Y_%m_%d_%H_%M_%S'.center(80, '/'))
print(result)
print(unixtime)
print(int(unixtime))
print(int(unixtime)*1000)
