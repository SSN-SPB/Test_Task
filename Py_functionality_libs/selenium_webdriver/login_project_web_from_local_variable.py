...
#### from package
USER = service_packages.get_local_variable_value('LOCAL_VARIABLE_'
                                                 'PROJECT_WEB_LOGON')
PASSWORD = service_packages.get_local_variable_value('LOCAL_VARIABLE_'
                                                     'PROJECT_WEB_PASSWORD')
PROJECT_WEB_URL = service_packages.get_local_variable_value('LOCAL_VARIABLE_'
                                                     'PROJECT_WEB_URL')
