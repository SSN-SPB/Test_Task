...
def main():
    ...
    # hue
    sns.countplot(
        x=count_Chinese_all_medal.Medal,
        data=count_Chinese_all_medal,
        hue=count_Chinese_all_medal.Gender,
    )
    plt.show()
    # hue
    sns.countplot(
    ...
    plt.show()
    # hue and palette
    sns.countplot(x="Gender", data=count_Chinese_all_medal, hue="Medal", palette="cool")
    plt.show()
