...
def main():
    ...
    plt.show()
    df.plot(x=fo.Sport, y=fo.Sport.value_counts(), figsize=(10,4),kind = 'pie', colormap='Pastel1')
    plt.show()
    df.plot(x=fo.Sport, y=fo.Sport.value_counts(), figsize=(10,4),kind = 'pie', colormap='Pastel2')
    plt.show()
    df.plot(x=fo.Sport, y=fo.Sport.value_counts(), figsize=(10,4),kind = 'pie', colormap='tab10')
    plt.show()
    df.plot(x=fo.Sport, y=fo.Sport.value_counts(), figsize=(10,4),kind = 'pie', colormap='bwr')
    plt.show()
    df.plot(x=fo.Sport, y=fo.Sport.value_counts(), figsize=(10,4),kind = 'pie', colormap='Greens')
    plt.show()  
