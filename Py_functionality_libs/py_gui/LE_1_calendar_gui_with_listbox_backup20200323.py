...
lab_service = library_gui_block.popup_label(
    pop_up2, "Service info: ", label_font="Arial 12", place_x=10, place_y=350
)
...
# list_input=library_gui_block.popup_input_text_list(place_x=input_text_left_border,place_y=first_row_y+step_row*9)
list_input = library_gui_block.popup_input_text_list(
    pop_up2, months, place_x=input_text_left_border, place_y=first_row_y + step_row * 9
)
# output multitext box adding
calendar_text = library_gui_block.popup_input_multiline_text(
    pop_up2, 7, place_y=200, width_of_multitext=60, place_x=10
)
