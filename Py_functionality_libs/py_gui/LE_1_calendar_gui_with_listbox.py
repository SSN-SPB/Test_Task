...
import library_gui_block as gui_block
...
# PopUp2 Creating
pop_up2 = gui_block.main_popup(gui_title,
                               gui_popup_size_x,
                               gui_popup_size_y)
# PopUp2 labels adding
lab_year = gui_block.popup_label(pop_up2, text_define_year,
                                 label_font=font_Arial_12,
                                 place_x=num_10,
                                 place_y=FIRST_ROW_Y + step_row * 2)
lab_calendar = gui_block.popup_label(pop_up2, text_calendar,
                                     label_font=font_Arial_12,
                                     place_x=num_10,
                                     place_y=FIRST_ROW_Y + step_row * 5)
lab_service = gui_block.popup_label(pop_up2, text_service_info,
                                    label_font=font_Arial_12,
                                    place_x=num_10,
                                    place_y=FIRST_ROW_Y + step_row * 9)
lab_month_list = gui_block.popup_label(pop_up2,
                                       select_month_text,
                                       label_font=font_Arial_12,
                                       place_x=num_10,
...
year_text = gui_block.popup_input_text(text_year, pop_up2,
                                       font_Arial_12, 20, 3,
                                       place_y=y_place,
                                       place_x=input_text_left_border)
row_num = 10
y_place = FIRST_ROW_Y + step_row * row_num
wrong_input_text = gui_block.popup_input_text(wrong_text_message,
...
row_num = 0
y_place = FIRST_ROW_Y + step_row * row_num
list_input = gui_block.popup_input_text_list(pop_up2,
                                             months,
                                             place_x=x_place,
                                             place_y=y_place,
...
row_num = 6
y_place = FIRST_ROW_Y + step_row * row_num
calendar_text = gui_block.popup_input_multiline_text(pop_up2,
                                                     num_7,
                                                     place_y=y_place,
...
row_num = 4
y_place = FIRST_ROW_Y + step_row * row_num
see_calendar_button = gui_block.popup_button(pop_up2,
                                             press_button_text,
                                             name_for_button,
                                             get_calendar_value,
                                             num_20,
