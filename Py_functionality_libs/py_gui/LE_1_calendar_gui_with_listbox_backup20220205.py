...
incorrect_input_message = 'The input is not correct.' \
                          ' The calendar displaying is stopped'
press_button_text = 'Press To view calendar'
name_for_button = '<Button-1>'
wrong_value_message = 'Some input data is wrong.' \
                      ' Check it and try to reenter, please'
...
# PopUp2 Creating
pop_up2 = library_gui_block.main_popup(gui_title,
                                       gui_popup_size_x,
                                       gui_popup_size_y)
# PopUp2 labels adding
lab_year = library_gui_block.popup_label(pop_up2, text_define_year,
                                         label_font=font_Arial_12,
                                         place_x=num_10,
                                         place_y=first_row_y + step_row * 2)
lab_calendar = library_gui_block.popup_label(pop_up2, text_calendar,
                                             label_font=font_Arial_12,
                                             place_x=num_10,
                                             place_y=first_row_y + step_row * 5)
lab_service = library_gui_block.popup_label(pop_up2, text_service_info,
                                            label_font=font_Arial_12,
                                            place_x=num_10,
                                            place_y=first_row_y + step_row * 9)
lab_month_list = library_gui_block.popup_label(pop_up2,
                                               select_month_text,
                                               label_font=font_Arial_12,
                                               place_x=num_10,
...
year_text = library_gui_block.popup_input_text(text_year, pop_up2,
                                               font_Arial_12, 20, 3,
                                               place_y=y_place,
                                               place_x=input_text_left_border)
row_num = 10
y_place = first_row_y + step_row * row_num
wrong_input_text = library_gui_block.popup_input_text(wrong_text_message,
                                                      pop_up2, font_Arial_12,
                                                      60, 3,
                                                      place_y=y_place,
                                                      place_x=num_10)
...
row_num = 0
y_place = first_row_y + step_row * row_num
list_input = library_gui_block.popup_input_text_list(pop_up2,
                                                     months,
                                                     place_x=x_place,
                                                     place_y=y_place,
...
row_num = 6
y_place = first_row_y + step_row * row_num
calendar_text = library_gui_block.popup_input_multiline_text(pop_up2,
                                                             num_7,
                                                             place_y=y_place,
                                                             width_of_multitext=60,
                                                             place_x=num_10)

# PopUp2 button adding
row_num = 4
y_place = first_row_y + step_row * row_num
see_calendar_button = library_gui_block.popup_button(pop_up2,
                                                     press_button_text,
                                                     name_for_button,
                                                     get_calendar_value,
                                                     num_20,
